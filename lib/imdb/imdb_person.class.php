<?php
 ...
 /* $Id: imdb_person.class.php 571 2013-05-22 20:13:28Z izzy $ */
  ...
  * @version $Revision: 571 $ $Date: 2013-05-22 22:13:28 +0200 (Mi, 22. Mai 2013) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 571 $');
    $this->setid($id);
  }
