<?php
 ...
 /* $Id: imdb.class.php 567 2013-05-20 14:06:27Z izzy $ */
  ...
  * @version $Revision: 567 $ $Date: 2013-05-20 16:06:27 +0200 (Mo, 20. Mai 2013) $
  */
 ...
 #-----------------------------------------------------------[ Constructor ]---
  ...
  function __construct($id) {
    ...
    $this->revision = preg_replace('|^.*?(\d+).*$|','$1','$Revision: 567 $');
    $this->setid($id);
  }
